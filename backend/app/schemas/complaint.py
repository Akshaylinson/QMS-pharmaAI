...
class ComplaintBase(BaseModel):
    ...
    product_name: str | None = None; product_strength: str | None = None; batch_number: str | None = None; manufacturing_date: str | None = None; expiry_date: str | None = None; product_type: str | None = None; market_country: str | None = None
    originating_site: str | None = None; impacted_materials: str | None = None
    complaint_type: str | None = None; complaint_date: str | None = None; received_date: str | None = None; description: str | None = None; product_condition: str | None = None; affected_quantity: str | None = None; sample_available: bool | None = None; patient_impact: str | None = None; quality_impact: str | None = None; regulatory_impact: str | None = None; safety_concern: bool | None = None; severity: str | None = None; priority: str | None = None; risk_level: str | None = None; suggested_next_action: str | None = None; initial_risk_assessment: str | None = None; status: str = 'PENDING_REVIEW'
